...
| JavaScript            | Uses the [precompiled Ostrich Mersenne-Twister random number generator for JavaScript](https://github.com/Sable/ostrich-twister-prng.js/). This template is compatible with the [Browserify compiler](https://github.com/Sable/ostrich-browserify-compiler), and the [Node](https://github.com/Sable/ostrich-node-environment), [Chrome](https://github.com/Sable/ostrich-chrome-environment), [Firefox](https://github.com/Sable/ostrich-firefox-environment), and [Safari](https://github.com/Sable/ostrich-safari-environment) environments  | https://github.com/Sable/js-implementation-template.git |
